...
| DEC-A | 2026-09-14 | STOP A: target profiles, track split, tolerances `tol-p1-v1`, access posture and D10-1..6 as written in `stops/STOP_A.md` | approve as-is / amend rows | approve as-is (with D10-4 option (a): PAT identity accepted for this run; rehearsal fallback freeze-and-load until D10-1 closes; `cdc_lag_max_s: 60`) | PENDING | — | setup | all downstream |
