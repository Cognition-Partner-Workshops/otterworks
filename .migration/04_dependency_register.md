...
| R1–R4 | lead-time requests | 6,7,8 | R1 feed encoding/terminator (D3-3); R2 finance recipients + format (D4-1); R3 shared-drive pickup (D4-4); R4 production landing owner/mechanism (D7-1/D10-6) | customer | FIRED | STOP C post https://cogpartners.slack.com/archives/C0BQP3P965V/p1788298142807729; needed before STOP E. |
