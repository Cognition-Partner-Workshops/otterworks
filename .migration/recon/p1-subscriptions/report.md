...
- Seed: `0`
- Tier 3 depth: `full`
- Generated: 2026-09-15T08:02:59.247214+00:00
- Cost: `{"source_statements": 78, "source_rows_fetched": 267, "target_statements": 75, "target_rows_fetched": 203, "elapsed_s": 9.238}`
...
```json
{
  ...
  "markers": {
    "subscriptions": {
      "source_open": [
        "69",
        "fe6f5e18-3d44-a720-dc37-a89edff1cbf6"
      ],
      "source_close": [
        "69",
        "fe6f5e18-3d44-a720-dc37-a89edff1cbf6"
...
{
  "unverified": [
    "subscriptions: OracleJdbcSourceAdapter reads no constraint metadata: tiers 5-7 are part of the degraded surface and are reported as unverified, not guessed"
  ]
}
```
