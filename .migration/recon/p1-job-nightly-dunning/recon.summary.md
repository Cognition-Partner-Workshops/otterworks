...
# Recon summary: `p1-job-nightly-dunning` - **PASS**
...
- Mapping `map-p1-v1` / tolerances `v1` / seed `0` / depth `sampled`
- Generated: 2026-09-15T11:13:16.886063+00:00
- Cost: source 18 statements / 7 rows fetched; target 12 statements / 4 rows; 1.247s
