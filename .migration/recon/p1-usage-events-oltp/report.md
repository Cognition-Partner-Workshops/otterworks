...
# Recon report: unit `p1-usage-events-oltp`
...
- Seed: `0`
- Tier 3 depth: `full`
- Generated: 2026-09-15T11:14:52.118684+00:00
- Cost: `{"source_statements": 79, "source_rows_fetched": 1757, "target_statements": 75, "target_rows_fetched": 1693, "elapsed_s": 9.436}`
- **WARNING: UNVERIFIED schema_parity: usage_events: OracleJdbcSourceAdapter reads no constraint metadata: tiers 5-7 are part of the degraded surface and are reported as unverified, not guessed**
...
{
  "usage_events": {
    "watermark": "occurred_at->occurred_at",
    "unit": "datetime",
    "source_max": "2026-02-28 10:00:00",
    "target_max": "2026-02-28 10:00:00",
    "lag_s": 0.0,
    "lag_units": null,
    "in_flight": 0,
    "in_flight_deletes": 0,
...
{
  "unverified": [
    "usage_events: OracleJdbcSourceAdapter reads no constraint metadata: tiers 5-7 are part of the degraded surface and are reported as unverified, not guessed"
  ]
}
```
