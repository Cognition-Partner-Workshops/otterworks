...
- Seed: `0`
- Tier 3 depth: `full`
- Generated: 2026-09-15T08:56:33.972064+00:00
- Cost: `{"source_statements": 18, "source_rows_fetched": 13, "target_statements": 14, "target_rows_fetched": 10, "elapsed_s": 1.645}`
...
```json
{
  "invoices": {
    ...
    "unit": "datetime",
    "source_max": "2026-02-28 00:00:00",
    "target_max": "2026-02-28 00:00:00",
    "lag_s": 0.0,
    "lag_units": null,
    "in_flight": 0,
    "in_flight_deletes": 0,
...
{
  "unverified": [
    "invoices: OracleJdbcSourceAdapter reads no constraint metadata: tiers 5-7 are part of the degraded surface and are reported as unverified, not guessed"
  ]
}
```
