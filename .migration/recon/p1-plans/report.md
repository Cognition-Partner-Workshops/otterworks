...
- Seed: `0`
- Tier 3 depth: `full`
- Generated: 2026-09-15T07:00:51.077879+00:00
- Cost: `{"source_statements": 17, "source_rows_fetched": 13, "target_statements": 14, "target_rows_fetched": 10, "elapsed_s": 1.651}`
- **WARNING: UNVERIFIED schema_parity: plans: OracleJdbcSourceAdapter reads no constraint metadata: tiers 5-7 are part of the degraded surface and are reported as unverified, not guessed**
...
{
  "unverified": [
    "plans: OracleJdbcSourceAdapter reads no constraint metadata: tiers 5-7 are part of the degraded surface and are reported as unverified, not guessed"
  ]
}
```
