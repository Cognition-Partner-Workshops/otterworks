...
|---|---|---|---|---|---|---|---|---|
| u-00-codes | 0 | migrated (single-session); independent recon pending | fixture PASS 32/32, target_class=local, merge_eligible=false | 0 | live recon (no source) | ~0.5 h lead+sidekick | https://github.com/Cognition-Partner-Workshops/otterworks/pull/1708 | open, not mergeable on offline evidence |
