...
| 1 | U4 files (DynamoDB) | RECON_GREEN | PASS (fixture; `.migration/recon/U4/gate/result.json`) | 0% (no quarantine) | 4 (see `docs/tech-partnerships/recon/U4.recon.json`) | 5 loads + 3 recons, ~4 min | #1419 |
