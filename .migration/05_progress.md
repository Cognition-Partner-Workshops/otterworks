...
| 8 | finance_excel_report.pl | 2 | IN_PROGRESS | ns `finance-w2`: `gold.finance_billing`, `landing/finance-w2/reports/` (silver rows parent-seeded); notebook `/Shared/ow_tp/custbill/finance` | – | – | – | – | – |
