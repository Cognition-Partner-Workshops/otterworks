...
| C | POSTED, waiting | 2026-09-14 | `docs/migration/P1_monthly_invoicing_analysis.md`, `P1_monthly_invoicing_plan.md`, `.migration/waves/wave-{0,1,2}.json`, `.migration/stops/STOP_C.md` |
| D | per wave | | |
| E | not started | | |
...
| U4 invoicing-credits (`INVOICES`, `INVOICE_LINES`, `CREDIT_NOTES`, `PKG_INVOICING`) | operational | 2 | NOT_STARTED | | | | | |
