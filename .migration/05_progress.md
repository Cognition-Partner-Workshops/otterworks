...
| 7 | parse_custbill_fixedwidth.sh | 2 | IN_PROGRESS | ns `parse-w2` (+ `parse-w2-anom`): `silver.custbill_records`, `silver.custbill_quarantine` (bronze rows parent-seeded); notebook `/Shared/ow_tp/custbill/parse` | – | – | – | – | – |
