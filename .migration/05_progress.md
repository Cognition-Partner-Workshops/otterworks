...
| 2 (B2-1) | U4 fact_commission + job load_commission_facts | MERGED | exact (cents) | 0 | live-legacy-comparison (DEGRADED); cross-table atomicity (DEC-015, closes at parallel run) | #1431 | ≈8.5 ACU (batch, shared with U5) / ≈5.4 wh-min child + ≈1 parent |
| 2 (B2-1) | U5 mv_agent_commission_summary | MERGED | exact (cents) | 0 | live-legacy-comparison (DEGRADED) | #1431 | (in U4 batch line) |
