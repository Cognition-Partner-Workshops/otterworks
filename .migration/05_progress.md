...
| 6 | sftp_ingest_poll.ksh | 1 (pilot) | RECON_GREEN (PR_OPEN 2026-09-01; fixture recon GREEN, U6-a/b/c/e pass, idempotency pass) | ns `sftp-ingest-poll-w1`: `bronze.custbill_raw`, `landing/sftp-ingest-poll-w1/{incoming,archive}`; notebook `/Shared/ow_tp/custbill/ingest` | n/a (ingest) | n/a (ingest) | production mainframe SFTP producer (R4); production encoding (R1); prod/UAT host roots /data/otterworks, /data2/otterworks_uat | [#1429](https://github.com/Cognition-Partner-Workshops/otterworks/pull/1429) | 2 serverless job runs (~3 min) |
...
| D (per wave) | wave 0 closed 2026-09-01 (#1421 merged); wave 1 U6 pilot launched | 2026-09-01 | https://github.com/Cognition-Partner-Workshops/otterworks/pull/1421 |
| E | – | | |
