...
Command: `python3 scripts/tp_dbx/cdw_recon.py --unit <unit> --ns cdw --run-mode fixture --baseline-dir etl/legacy-extra/commission_dw/cdw --rerun "<unit load command, argv-only>" --out dbx/commission_dw/<unit>/recon/` then `make tp-validate-recon FILE=dbx/commission_dw/<unit>/recon/<unit>.recon.json`.
