...
| 7 | Databricks CLI + OAuth M2M migration service principal `dhrov_spa` (`DATABRICKS_DEMO_HOST`, `DATABRICKS_CLIENT_ID/SECRET` secret names; prior PAT row superseded 2026-09-14, DEC-C) | WORKS | `current-user me`: `2e90bc1d-e9a1-4703-8c48-ad28ebb1864d` (`service_principal=true`). Workspace `dbc-8bc9474f-40ae.cloud.databricks.com`; `postgres list-branches projects/ow-tp-billing` succeeds. | — |
