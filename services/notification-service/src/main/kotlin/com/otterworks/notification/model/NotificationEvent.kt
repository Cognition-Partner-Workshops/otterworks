...
/**
 * Accepts timestamps as either an RFC 3339 string or a Unix epoch number
 * (seconds or milliseconds), normalizing to an ISO-8601 string. Legacy
 * events from older service versions emit epoch integers.
 */
object FlexibleTimestampSerializer : KSerializer<String> {
    ...
    override fun deserialize(decoder: Decoder): String {
        ...
        val epoch = primitive.content.toLongOrNull()
            ?: throw SerializationException("Invalid timestamp: ${primitive.content}")
