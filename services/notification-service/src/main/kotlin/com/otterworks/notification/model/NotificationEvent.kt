...
/**
 * Accepts timestamps as either an RFC 3339 string or a legacy Unix epoch
 * number (seconds or milliseconds), normalizing to an ISO-8601 string.
 */
object FlexibleTimestampSerializer : KSerializer<String> {
    private const val EPOCH_MILLIS_THRESHOLD = 10_000_000_000L

    override val descriptor = PrimitiveSerialDescriptor("FlexibleTimestamp", PrimitiveKind.STRING)
    ...
    override fun deserialize(decoder: Decoder): String {
        ...
        val epoch = primitive.long
        return if (epoch > EPOCH_MILLIS_THRESHOLD) {
