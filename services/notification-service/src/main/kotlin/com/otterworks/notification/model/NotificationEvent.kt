...
/**
 * Deserializes event timestamps that may arrive either as RFC 3339 strings
 * or as Unix epoch numbers (seconds or milliseconds) emitted by legacy
 * service versions. Epoch values are normalized to RFC 3339 strings.
 */
