...
/**
 * Accepts timestamps as either RFC 3339 strings or legacy Unix epoch
 * integers (seconds or milliseconds), normalizing to an ISO-8601 string.
 */
object FlexibleTimestampSerializer : KSerializer<String> {
    ...
    override fun deserialize(decoder: Decoder): String {
        ...
        val epoch = primitive.content.toLong()
