                ...
                for (msg in messages) {
                    launch {
                        try {
                            ...
                            // Always delete the message to prevent poison pills
                            // from causing unbounded queue growth.
    ...
    internal fun parseMessage(body: String): SqsNotificationMessage? {
        ...
        return try {
            ...
            try {
                ...
                // Strict parser failed — fall back to lenient parser to handle
                // legacy messages with epoch-integer timestamps.
                if (useStrict) {
    ...
    private fun parseLenient(body: String): SqsNotificationMessage? {
        return try {
            ...
            try {
                ...
                logger.error(e) { "Failed to parse message body even with lenient parser" }
                null
            }
        }
    }
