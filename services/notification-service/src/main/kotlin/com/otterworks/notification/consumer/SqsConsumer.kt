                    ...
                    launch {
                        try {
                            ...
                            if (event != null) {
                                ...
                                logger.warn { "Failed to parse SQS message, deleting poison pill: ${msg.messageId}" }
                            }

                            // Always delete the message to prevent poison-pill reprocessing.
    ...
    internal fun parseMessage(body: String): SqsNotificationMessage? {
        ...
        return try {
            ...
            try {
                ...
                // Fallback: use lenient parser for legacy messages (e.g. epoch timestamps)
                parseLenient(body)
            }
        }
    }
