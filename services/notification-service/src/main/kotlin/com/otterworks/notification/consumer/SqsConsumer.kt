                ...
                for (msg in messages) {
                    launch {
                        try {
                            ...
                            // Always delete the message — poison messages that
                            // cannot be deserialized must not stay in the queue
                            // or they will re-enter after the visibility timeout
                            // and cause unbounded queue depth growth.
