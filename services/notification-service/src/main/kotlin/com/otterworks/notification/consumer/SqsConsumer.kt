                ...
                for (msg in messages) {
                    launch {
                        try {
                            ...
                            // Always delete the message from the queue to prevent
                            // unbounded queue depth growth. Unparseable messages would
                            // never succeed on retry so leaving them causes infinite
                            // reprocessing after the visibility timeout expires.
