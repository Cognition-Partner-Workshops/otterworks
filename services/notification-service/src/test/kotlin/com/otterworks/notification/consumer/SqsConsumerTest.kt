...
class SqsConsumerTest {
    ...
    @Test
    fun `parseMessage parses legacy message with epoch timestamp`() {
        val body = """
            {
                "eventType": "file_shared",
                "fileId": "file-999",
        ...
        assertEquals("1718450000", event.timestamp)
    }

    @Test
    fun `parseMessage parses message with extra unknown fields`() {
        val body = """
            {
                "eventType": "file_shared",
                "fileId": "file-123",
