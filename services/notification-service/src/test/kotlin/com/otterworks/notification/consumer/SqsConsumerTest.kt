...
class SqsConsumerTest {
    ...
    @Test
    fun `parseMessage parses legacy integer epoch timestamp`() {
        val body = """
            {
                "eventType": "file_shared",
                "fileId": "file-999",
    ...
    @Test
    fun `parseMessage parses SNS-wrapped message with integer epoch timestamp`() {
    ...
    @Test
    fun `parseMessage handles message with extra unknown fields`() {
        val body = """
            {
                "eventType": "file_shared",
                "fileId": "file-123",
