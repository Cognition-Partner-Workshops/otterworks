...
def suggest() -> tuple:
    ...
    # Ranking-score enrichment: MeiliSearch only returns _rankingScore when
    # explicitly requested, so suggestions may lack the field. Sort with a
    # safe fallback score instead of indexing the key directly.
