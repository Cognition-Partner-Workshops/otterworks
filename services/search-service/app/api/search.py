...
def suggest() -> tuple:
    ...
    # Ranking-score enrichment path: sorts suggestions by _rankingScore when
    # available. Suggestions without a ranking score (e.g. plain strings or
    # hits where MeiliSearch omitted the field) are treated as score 0 so the
    # endpoint degrades gracefully instead of returning a 500.
