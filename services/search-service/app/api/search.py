...
def suggest() -> tuple:
    ...
    try:
        ...
        # When the ranking-score enrichment flag is active, use
        # suggest_with_scores to sort suggestions by MeiliSearch relevance.
        if _chaos_active("chaos:search-service:suggest_500"):
            scored_suggestions = service.suggest_with_scores(prefix)
            ranked = sorted(
                scored_suggestions,
