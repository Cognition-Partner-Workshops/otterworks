...
def suggest() -> tuple:
    ...
    # CHAOS: deliberately failing path for the search-suggest-500 incident lab
    # (scripts/bug-catalog.yaml). When the flag is set, reproduce the original
    # regression: a KeyError from looking up _rankingScore on entries that
    # don't carry it, crashing the handler with a 500.
