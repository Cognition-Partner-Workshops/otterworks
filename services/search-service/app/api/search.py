...
def suggest() -> tuple:
    ...
    # Ranking-score enrichment: sort suggestions by MeiliSearch relevance.
    # _rankingScore is only present on hits when explicitly requested, so
    # entries without it default to 0.0 and sort last.
