...
def suggest() -> tuple:
    ...
    # When the ranking-score enrichment flag is active, fetch suggestions
    # with ranking scores and sort by relevance before returning.
    if _chaos_active("chaos:search-service:suggest_500"):
        try:
            ...
            suggestions = [s["text"] for s in ranked]
