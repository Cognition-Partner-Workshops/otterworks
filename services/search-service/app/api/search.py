...
def suggest() -> tuple:
    ...
    # Ranking-score enrichment path: sorts suggestions by MeiliSearch's
    # _rankingScore when available, defaulting to 0.0 since MeiliSearch only
    # returns the field when explicitly requested.
