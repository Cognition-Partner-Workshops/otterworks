...
def suggest() -> tuple:
    ...
    # Ranking-score enrichment: sort suggestions by MeiliSearch _rankingScore
    # when present. The field is only returned when explicitly requested, so
    # treat it as optional and fall back to insertion order.
