...
def suggest() -> tuple:
    ...
    # Optional ranking-score enrichment: sort suggestions by relevance when a
    # _rankingScore is present. MeiliSearch only includes that field when
    # explicitly requested, so treat it as optional and never let its absence
    # fail the request.
