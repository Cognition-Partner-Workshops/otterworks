...
def suggest() -> tuple:
    ...
    # Ranking-score enrichment: sort suggestions by MeiliSearch's
    # _rankingScore when present. Entries without a score keep their
    # original relevance order, so plain string suggestions pass through
    # unchanged instead of crashing the handler.
