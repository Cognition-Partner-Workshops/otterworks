...
class MeiliSearchService:
    ...
    def suggest_ranked(self, prefix: str, size: int = 10) -> list[dict[str, Any]]:
        """Autocomplete suggestions with ranking scores from MeiliSearch.

        Returns raw hit dicts containing title/name and _rankingScore so
        callers can sort by relevance.
        """
