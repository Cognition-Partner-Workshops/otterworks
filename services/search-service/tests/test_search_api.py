...
class TestSuggestEndpoint:
    ...
    def test_suggest_ranking_path_returns_200(self, client, mock_meilisearch_client, monkeypatch):
        """Ranking-score enrichment must not 500 when _rankingScore is absent."""
