...
class TestSuggestEndpoint:
    ...
    def test_suggest_ranked_path_returns_200(self, client, mock_meilisearch_client, monkeypatch):
        """Ranking-score enrichment path returns 200 even without _rankingScore."""
    ...
    def test_suggest_ranked_path_empty_index(self, client, monkeypatch):
        """Ranking-score enrichment path with empty index returns 200, not 500."""
        import app.api.search as search_module
