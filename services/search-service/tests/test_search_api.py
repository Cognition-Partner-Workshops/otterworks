...
class TestSuggestEndpoint:
    ...
    def test_suggest_ranking_enrichment_does_not_crash(self, client, mock_meilisearch_client, monkeypatch):
        """Suggest returns 200 with ranking enrichment active and no _rankingScore."""
