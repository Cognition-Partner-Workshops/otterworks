...
class TestSuggestEndpoint:
    ...
    def test_suggest_ranking_path_no_500(self, client, mock_meilisearch_client, monkeypatch):
        """Suggest returns 200 on the ranking path even without _rankingScore."""
    ...
    def test_suggest_ranking_path_empty_index(self, client, mock_meilisearch_client, monkeypatch):
        """Suggest returns 200 on the ranking path with an empty index."""
        import app.api.search as search_module
