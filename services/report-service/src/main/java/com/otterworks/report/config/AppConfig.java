 ...
 * - Optionally replace Apache HttpComponents with Reactor Netty or the JDK HTTP client
 */
@Configuration
public class AppConfig {
    ...
    // RestTemplate with an Apache HttpComponents 5 connection pool
    @Bean
    public RestTemplate restTemplate() {
        ...
        // HttpClient 5 owns the read timeout: HttpComponentsClientHttpRequestFactory
        // no longer exposes setReadTimeout, so it becomes the response timeout.
