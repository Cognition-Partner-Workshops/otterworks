 ...
 *
 * LEGACY PATTERNS:
 * - jakarta.validation.* annotations (target: jakarta.validation.*)
...
public class ReportRequest {
    ...
    @Schema(description = "Human-readable name for the report", example = "Monthly Usage Report", requiredMode = Schema.RequiredMode.REQUIRED)
