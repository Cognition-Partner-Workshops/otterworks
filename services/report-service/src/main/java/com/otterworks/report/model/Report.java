...
public class Report {
    ...
    // Hibernate 6 maps @Lob String to a PostgreSQL large object (oid); LONG32VARCHAR keeps
    // the Hibernate 5 mapping to a plain text column, which is what the table already uses.
    @Lob
