...
/**
 * Generates PDF reports using OpenPDF, the maintained fork of iText 5.
 *
 * The document model is iText 5's: colours are java.awt.Color rather than
 * iText's BaseColor, and fonts are addressed by the Font family constants.
 *
 * LEGACY PATTERNS:
