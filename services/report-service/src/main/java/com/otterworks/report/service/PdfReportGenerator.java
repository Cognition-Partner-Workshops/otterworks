...
public class PdfReportGenerator {
    ...
    private static final Font TITLE_FONT = FontFactory.getFont(FontFactory.HELVETICA_BOLD, 18, java.awt.Color.DARK_GRAY);
    private static final Font SUBTITLE_FONT = FontFactory.getFont(FontFactory.HELVETICA, 12, java.awt.Color.GRAY);
    private static final Font HEADER_FONT = FontFactory.getFont(FontFactory.HELVETICA_BOLD, 10, java.awt.Color.WHITE);
    private static final Font CELL_FONT = FontFactory.getFont(FontFactory.HELVETICA, 9, java.awt.Color.BLACK);
    private static final java.awt.Color HEADER_BG = new java.awt.Color(44, 62, 80);
    private static final java.awt.Color ALT_ROW_BG = new java.awt.Color(236, 240, 241);
