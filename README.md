...
| Report Service | Java 17 | Spring Boot 3.5 | 8091 | PDF/CSV/Excel report generation |

> **Note:** The Report Service now runs Java 17, Spring Boot 3.5, JUnit 5, and Jakarta APIs. It keeps only the deliberate commons-text 1.9 pin for the dependency-CVE remediation lab. See `services/report-service/pom.xml` for details.
...
│   └── report-service/    #   Java 17 / Spring Boot 3.5
