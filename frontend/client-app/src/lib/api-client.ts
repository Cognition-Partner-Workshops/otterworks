...
function configureApiClient(client: ReturnType<typeof axios.create>, transformResponse: boolean) {
...
function createApiClient(transformResponse: boolean) {
  return configureApiClient(axios.create({
...
export function createRawApiClient() {
