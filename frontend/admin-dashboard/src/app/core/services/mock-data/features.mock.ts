...
export const MOCK_FEATURE_FLAGS: FeatureFlag[] = [
  {
    id: 'flag-001', name: 'Real-time Collaboration', key: 'real-time-collab',
  ...
  {
    id: 'flag-002', name: 'AI Document Summary', key: 'ai-doc-summary',
  ...
  {
    id: 'flag-003', name: 'Advanced Search', key: 'advanced-search',
  ...
  {
    id: 'flag-004', name: 'File Versioning', key: 'file-versioning',
  ...
  {
    id: 'flag-005', name: 'Webhook Notifications', key: 'webhook-notifications',
  ...
  {
    id: 'flag-006', name: 'Dark Mode', key: 'dark-mode',
  ...
  {
    id: 'flag-007', name: 'Bulk File Operations', key: 'bulk-file-ops',
  ...
  {
    id: 'flag-008', name: 'Public Link Sharing', key: 'public-link-sharing',
  ...
  {
    id: 'flag-009', name: 'Usage Analytics Dashboard', key: 'usage-analytics',
  ...
  {
    id: 'flag-010', name: 'Two-Factor Authentication', key: '2fa-auth',
