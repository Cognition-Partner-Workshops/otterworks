#!/usr/bin/env python3
"""Wave 1 unit `customers`: CUSTOMER_MASTER (+ENTITY_ATTR_VALUE CUSTOMER embed),
CUSTOMER_MASTER_HIST, scoped ENTITY_ATTR_VALUE remainder -> customers /
customerVersions / entityAttrValue on the offline estate.
...
COLLECTIONS = ["customers", "customerVersions", "entityAttrValue"]
