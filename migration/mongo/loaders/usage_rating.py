#!/usr/bin/env python3
"""Wave 2 unit `usage-rating`: USAGE_EVENTS + RATING_PERIODS (embeds
RATING_RESULTS as results[]) -> usageEvents / ratingPeriods on the offline
estate.
...
COLLECTIONS = ["usageEvents", "ratingPeriods"]
