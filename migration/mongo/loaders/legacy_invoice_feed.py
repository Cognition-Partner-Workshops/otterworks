#!/usr/bin/env python3
"""Wave 1 unit `legacy-invoice-feed`: INVOICE_HEADER + INVOICE_LINE ->
legacyInvoices / legacyInvoiceLines on the offline estate. Lines stay a
separate collection keyed lineId; orphan lines (invoiceId with no header)
are legitimate rows and load normally.
...
COLLECTIONS = ["legacyInvoices", "legacyInvoiceLines"]
