...
PROCS_TARGET_DOCS_PORT = $(shell test -n "$(PROCS_PORT_OFFSET)" && python3 -c "print(57432 + $(PROCS_PORT_OFFSET))")
PROCS_ENV = NS=$(NS) PROCS_DB_PORT=$(PROCS_DB_PORT) PROCS_APP_PORT=$(PROCS_APP_PORT) PROCS_TARGET_DB_PORT=$(PROCS_TARGET_DB_PORT) PROCS_TARGET_PORT=$(PROCS_TARGET_PORT) PROCS_TARGET_DOCS_PORT=$(PROCS_TARGET_DOCS_PORT)
