...
tp-demo-reset: ## Reset Databricks demo state for the migration rerun (dry-run; APPLY=1 to delete; ORACLE=<instance-id> to start Oracle)
	python3 scripts/tp_dbx/demo_reset.py $(if $(APPLY),--apply) $(if $(ORACLE),--start-oracle $(ORACLE)) $(ARGS)
